        ...
        <div className="fade-up" style={{ marginBottom: "28px", position: "relative", zIndex: 100 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <NotificationBell />
              <div style={{ padding: "6px 12px", borderRadius: "99px", background: "var(--bg-elevated)", border: "1px solid var(--border-default)", fontSize: "11px", color: "var(--text-muted)", display: "flex", alignItems: "center", gap: "6px" }}>
